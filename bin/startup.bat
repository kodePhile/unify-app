...
rem For now always set working folder to UNIFY_HOME
rem In future should be able to pass it as batch file argument
set "WORKING_FOLDER=%UNIFY_HOME%"

rem Start instance
start java -Xmx128m -Xms128m -cp "WEB-INF/lib/*" com.tcdng.unify.core.Unify %START_OPERATION% -w %WORKING_FOLDER%
